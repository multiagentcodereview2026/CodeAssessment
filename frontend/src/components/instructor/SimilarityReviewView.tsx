          ...
          <div className="bg-rose-50 border border-rose-200 rounded-3xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3.5 py-2 bg-white hover:bg-slate-100 text-slate-700 rounded-xl text-xs font-bold border border-slate-200 transition-colors"
              >
                Dismiss Flag
              </button>
              <button
                onClick={() => handleAction('Interview Scheduled with both students')}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-slate-800 font-mono text-xs">
              ...
              <div className="p-5 bg-slate-900/60">
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-800">
                  ...
                  <span className="text-xs px-2 py-0.5 bg-indigo-500/10 text-indigo-300 rounded border border-indigo-500/20">
                    Student A
                  </span>
                </div>
              ...
              <div className="p-5 bg-slate-950/60">
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-800">
                  ...
                  <span className="text-xs px-2 py-0.5 bg-rose-500/10 text-rose-300 rounded border border-rose-500/20">
                    Student B
                  </span>
                </div>
                <pre className="text-slate-300 leading-relaxed overflow-x-auto whitespace-pre">

...
export const AssignmentsManagerView: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-12 animate-fadeIn">
      ...
      {/* Assignment Cards (Matches Step 6 in diagram) */}
        ...
        {assignments.map((asg) => (
          ...
          >
            ...
            <div className="flex items-center gap-6 w-full md:w-auto justify-between md:justify-end border-t md:border-t-0 pt-4 md:pt-0 border-slate-100">
              ...
              <button className="px-3 py-1.5 bg-slate-900 hover:bg-indigo-600 text-white rounded-xl text-xs font-bold transition-colors">
                Manage
              </button>
            </div>
          </div>
